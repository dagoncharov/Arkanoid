#Игра шарик
#Задача игры в том, чтобы не дать шарику упасть с платформы

#Подключаем графическую библиотеку
from tkinter import *

#подключим модули времени и случайные числа
import time
import random

#создадим объект - окно с игровым полем
tk = Tk()

#сделаем заголовок окна - Games с помощью свойства объекта title
tk.title ('Game')

#зафиксируем размеры окна свойством resizable
tk.resizable (0,0)

#поместим игровое поле выше остальных окон на компьютере
tk.wm_attributes ('-topmost', 1)

#создадим новый холс 400 на 500 пикселей
canvas = Canvas(tk, width = 500, height = 400, highlightthickness = 0)

#зададим для каждого видимого элемента отдельные координаты
canvas.pack ()
